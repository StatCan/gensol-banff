# Contributor Covenant Code of Conduct for the `banff` project

([Français](#code-de-conduite-pour-le-projet-banff))

Contributors to repositories hosted in `banff` are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the Values and Ethics Code for the Public Sector
...
# Code de conduite pour le projet `banff`
<!--markdownlint-enable MD025-->

([English](#contributor-covenant-code-of-conduct-for-the-project_banff))

Les contributeurs aux dépôts hébergés dans `banff` sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le Code de valeurs et d'éthique du secteur public.
