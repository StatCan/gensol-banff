...
def test_estimato_IT03(capfd, estimato_indata_01a, estimato_instatus_01a, estimato_inestimator_01b):
    """When a non-mandatory varlist is specified as an empty string, no fatal runtime error should occur
        In this case, the procedure should encounter the expected but unrelated error
