...
def test_outlierH01_a(capfd, outlier_indata_01, outlier_inhist_01):
    #### arrange
    indata=outlier_indata_01
    indata_hist = outlier_inhist_01

    # arrange assertions
    sas_log_path = os.path.dirname(__file__) + "/output-sas/outlierH01_a.txt"
    msg_list_sas            = []
    msg_list_sas_exact      = []
    msg_list_contains       = []
    ...
    msg_list_sas_exact.append("ERROR: method is mandatory")
...
@pytest.mark.m_validated
@pytest.mark.m_auto_pass
def test_outlierH01_b(capfd, outlier_indata_01, outlier_inhist_01):
    #### arrange
    indata=outlier_indata_01
    indata_hist = outlier_inhist_01

    # arrange assertions
    sas_log_path = os.path.dirname(__file__) + "/output-sas/outlierH01_b.txt"
    msg_list_sas            = []
    msg_list_sas_exact      = []
    msg_list_contains       = []
    msg_list_contains_exact = []
