"""The edits must be linear.  If not, Donor should not proceed.
...
def test_donorimp_j04_a(capfd, donorimp_indata_02, donorimp_instatus_02):
...
@pytest.mark.m_pass_as_is
@pytest.mark.m_auto_pass
def test_donorimp_j04_b(capfd, donorimp_indata_02, donorimp_instatus_02):
...
@pytest.mark.m_pass_as_is
@pytest.mark.m_auto_pass
def test_donorimp_j04_c(capfd, donorimp_indata_02, donorimp_instatus_02):

    banfftest.pytest_donorimp(
        # Procedure Parameters
        indata=donorimp_indata_02,
        instatus=donorimp_instatus_02,
        edits="Q1 + Q2 + Q3 + Q4 = 1/total;", 
        post_edits="Q1 + Q2 + Q3 + Q4 - total <= 0;",
        min_donors=1,
        percent_donors=1,
        n=3,
