...
id ident;
var X01 X02;
with X01 X01;/* the resulting 2 ratios will be:  X01_data/X01_hist and X02_data/X02_hist */
by prov;
run;proc print data=outlierstatus;
title "Example 4 - Outlier ratios detected by the SG method using 2 data sets";
run;
